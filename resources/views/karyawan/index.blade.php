                                        ...
                                        <tbody>
                                            @foreach ($karyawan as $d)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $d->jabatan }}</td>
                                                    <td>
                                                        <a href="https://wa.me/{{ addPhonePrefix($d->no_hp)}}">{{ $d->no_hp }}</a>
                                                    </td>
                                                    <td>
                                                        @if (empty($d->foto))
                                                    ...
                                                    <td>{{ $d->nama_dept }}</td>
                                                    <td>
                                                        <a href="mailto:{{ $d->alamat_email_kantor}}">{{ $d->alamat_email_kantor}}</a>
                                                    </td>
                                                    {{-- <td>{{ $d->kode_cabang }}</td> --}}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/karyawan/store" method="POST" id="frmKaryawan" enctype="multipart/form-data">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <input type="text" id="alamat_ktp" value="" class="form-control"
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <input type="text" id="alamat_domisili" value="" class="form-control"
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <input type="text" id="alamat_email_kantor" value="" class="form-control"
