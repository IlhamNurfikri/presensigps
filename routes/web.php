...
use App\Http\Controllers\BudgetingContoller;
...
Route::group(['middleware' => ['role:administrator,user']], function () {
    ...
    Route::post('/client/{kode_client}/update', [ClientController::class, 'update']);
    Route::post('/client/{kode_client}/delete', [ClientController::class, 'delete']);

    // item
    Route::post('/item/store', [ItemController::class, 'store']);
    Route::post('/item/edit', [ItemController::class, 'edit']);
    Route::post('/item/{kode_item}/update', [ItemController::class, 'update']);
    Route::post('/item/{kode_item}/delete', [ItemController::class, 'delete']);
